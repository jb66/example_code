...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--output_graph',
      type=str,
      default='/tmp/output_graph_one.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default='/tmp/intermediate_graph_one/',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='/tmp/output_labels_one.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='/tmp/retrain_logs_one',
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='/tmp/bottleneck_one',
      help='Path to cache bottleneck layer values as files.'
  )
  parser.add_argument(
      '--final_tensor_name',
      type=str,
      default='final_result_one',
      help="""\
